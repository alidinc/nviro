...
//        let titleOffset : CGFloat = appearance.showCircularIcon ? 0.0 : -12.0
    ...
    override open func viewDidAppear(_ animated: Bool) {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(SCLAlertView.keyboardWillShow(_:)), name:NSNotification.Name(NSNotification.Name.UIKeyboardWillShow.rawValue), object: nil);
        NotificationCenter.default.addObserver(self, selector: #selector(SCLAlertView.keyboardWillHide(_:)), name:NSNotification.Name(NSNotification.Name.UIKeyboardWillHide.rawValue), object: nil);
    }
    
    open override func viewDidDisappear(_ animated: Bool) {
        super.viewDidDisappear(animated)
        NotificationCenter.default.removeObserver(self, name: NSNotification.Name(NSNotification.Name.UIKeyboardWillShow.rawValue), object: nil)
        NotificationCenter.default.removeObserver(self, name: NSNotification.Name(NSNotification.Name.UIKeyboardWillHide.rawValue), object: nil)
    }
